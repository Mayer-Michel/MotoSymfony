 ...
 */
final class Version20250120102339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, bike_id_id INT DEFAULT NULL, image_path VARCHAR(255) NOT NULL, INDEX IDX_C53D045FD6E98703 (bike_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FD6E98703 FOREIGN KEY (bike_id_id) REFERENCES bike (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP FOREIGN KEY FK_C53D045FD6E98703');
